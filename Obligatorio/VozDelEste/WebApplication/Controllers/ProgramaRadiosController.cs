...
namespace WebApplication.Controllers
{
    public class ProgramaRadiosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,ImagenUrl,Descripcion")] ProgramaRadio programaRadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,ImagenUrl,Descripcion")] ProgramaRadio programaRadio)
        {
            if (ModelState.IsValid)
            {
